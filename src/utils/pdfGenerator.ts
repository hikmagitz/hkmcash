...
export const generateTransactionReceipt = (transaction: Transaction, enterpriseName: string) => {
  ...
  // Format amount without currency symbol for clean display
  const formatAmountForReceipt = (amount: number): string => {
    ...
    // Get currency symbol from a small amount
  ...
  const details = [
    ...
    { label: 'Amount', value: formatAmountForReceipt(transaction.amount), highlight: true },
