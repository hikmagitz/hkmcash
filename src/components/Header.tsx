        ...
        <div className="md:hidden">
          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="relative" ref={profileRef}>
              ...
              {isProfileOpen && (
                <div className="fixed right-4 mt-2 w-48 bg-white/95 dark:bg-gray-800/95 backdrop-blur-md rounded-xl shadow-2xl border border-white/20 dark:border-gray-700/50 z-[9999]">
                  <div className="py-1">
        ...
        <div className="hidden md:flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative" ref={profileRef}>
              ...
              {isProfileOpen && (
                <div className="fixed right-6 mt-2 w-56 bg-white/95 dark:bg-gray-800/95 backdrop-blur-md rounded-xl shadow-2xl border border-white/20 dark:border-gray-700/50 z-[9999]">
                  <div className="py-1">
